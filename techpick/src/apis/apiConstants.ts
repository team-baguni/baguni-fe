...
export const API_URLS = {
  ...
  DEV_LOGIN: `${API_ENDPOINTS.DEVELOPMENT}/${API_ENDPOINTS.USERS}/${API_ENDPOINTS.NEW}/${API_ENDPOINTS.LOGIN}`,
  DEV_SIGNUP: `${API_ENDPOINTS.DEVELOPMENT}/${API_ENDPOINTS.USERS}/${API_ENDPOINTS.NEW}/${API_ENDPOINTS.SIGNUP}`,
};
